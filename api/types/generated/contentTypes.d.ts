...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    exclude_from_statistics: Schema.Attribute.Boolean;
    initial_amount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::account.account'
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    owner_user: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contact_type: Schema.Attribute.DynamicZone<
      ['contact-type.employee', 'contact-type.vendor', 'contact-type.customer']
    > &
      Schema.Attribute.Required &
...
export interface ApiLoanLoan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disbursement_transaction: Schema.Attribute.Relation<
      'oneToOne',
      'api::transaction.transaction'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::loan.loan'> &
      Schema.Attribute.Private;
    monthly_installment: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    remaining_balance: Schema.Attribute.Decimal & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['Active', 'Paid Off', 'Defaulted']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Active'>;
